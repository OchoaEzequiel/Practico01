                ...
                switch (numero)
                {
                    ...
                    case 2:
                        ...
                        while (nuevolegislador == "1")
                        {
                            ...
                            int despacho = 0;
                            bool despachovalido = false;
                            bool despachoencontrado = false;
                            while (despachovalido == false || despachoencontrado == true)
                            {
                                ...
                                if (int.TryParse(despachoIng, out despacho) && despacho >= 1 && despacho <= 100)
                                {
                                    ...
                                    {
                                        if (legislador.getDespacho() == despacho)
                                        {
                                            Console.WriteLine("ESTE DESPACHO YA ESTA ASOCIADO A UN LEGISLADOR");
                                            despachoencontrado = true;
                                            break;
                                        }
                                    }
                                    if (despachoencontrado == false)
                                    {
                                        despachovalido = true;
                                    }
                                }
                                ...
                                {
                                    Console.WriteLine("INGRESE UN DESPACHO VALIDO");
                                }
                            }
                            if (despacho <= 50)
                            {
                    ...
                    case 5:
                        ...
                        if (int.TryParse(Console.ReadLine(), out int numeroIng))
                        {
                            ...
                            foreach (Legislador legislador in parlamento.Legisladores)
                            {
                                if (legislador.getDespacho() == numeroIng)
                                {
                    ...
                    case 6:
                        ...
                        if (int.TryParse(Console.ReadLine(), out int numeroIng2))
                        {
                            ...
                            foreach (Legislador legislador in parlamento.Legisladores)
                            {
                                if (legislador.getDespacho() == numeroIng2)
                                {
                    ...
                    case 7:
                        ...
                        if (int.TryParse(Console.ReadLine(), out int numeroIng3))
                        {
                            ...
                            foreach (Legislador legislador in parlamento.Legisladores)
                            {
                                if (legislador.getDespacho() == numeroIng3)
                                {
